...
class Command(BaseCommand):
    ...
    def _load_user(self):
        with open(
                'D:/Dev/api_yamdb/api_yamdb/static/data/users.csv',
                encoding='utf-8'
        ) as csvfile:
    ...
    def _load_category(self):
        with open(
                'D:/Dev/api_yamdb/api_yamdb/static/data/category.csv',
                encoding='utf-8'
        ) as csvfile:
            reader = csv.DictReader(csvfile)
            object_list = []
    ...
    def _load_genre(self):
        with open(
                'D:/Dev/api_yamdb/api_yamdb/static/data/genre.csv',
                encoding='utf-8'
        ) as csvfile:
            reader = csv.DictReader(csvfile)
            object_list = []
    ...
    def _load_title(self):
        with open(
                'D:/Dev/api_yamdb/api_yamdb/static/data/titles.csv',
                encoding='utf-8'
        ) as csvfile:
            reader = csv.DictReader(csvfile)
            object_list = []
    ...
    def _load_genretitle(self):
        with open(
                'D:/Dev/api_yamdb/api_yamdb/static/data/genre_title.csv',
                encoding='utf-8'
        ) as csvfile:
            reader = csv.DictReader(csvfile)
            object_list = []
    ...
    def _load_comment(self):
        with open(
                'D:/Dev/api_yamdb/api_yamdb/static/data/comments.csv',
                encoding='utf-8'
        ) as csvfile:
            reader = csv.DictReader(csvfile)
            for row in reader:
